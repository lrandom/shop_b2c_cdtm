    ...
    <div class="news--ticker">
        <div class="container">
            ...
            <div class="news-updates--list" data-marquee="true">
                <ul class="nav">
                    @foreach($tickerNews as $tickerNew)
                        <li>
                            <h3 class="h3"><a href="{{route('fe.post.detail',['id'=>$tickerNew->id])}}">
                                    {{$tickerNew->title}}
                                </a>
                            </h3>
                        </li>
                            ...
                            <div class="post--item post--layout-1 post--title-larger">
                                <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb">
                                        <img src="{{asset($firstNews->thumbnail_path)}}"
                                             alt=""/></a>
                                    <a href="#"
                                    ...
                                    <div class="post--info">
                                        <ul class="nav meta">
                                            <li><a href="#">{{$firstNews->title}}</a></li>
                                    ...
                                    <div class="post--item post--layout-1 post--title-large">
                                        <div class="post--img">
                                            <a href="news-single-v1.html" class="thumb"><img
                                                    src="{{asset($firstNews->thumbnail_path)}}" alt=""/></a> <a href="#"
                                                                                                                class="cat">Travel</a>
                                            <a href="#" class="icon"><i class="fa fa-flash"></i></a>
                                            <div class="post--info">
                                                <ul class="nav meta">
                                                ...
                                                <div class="title">
                                                    <h2 class="h4"><a href="news-single-v1.html" class="btn-link">{{
    $secondNews->title
}}</a></h2>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6 ptop--30 pbottom--30">
                                ...
                                <div class="post--items post--items-2" data-ajax-content="outer">
                                    <ul class="nav row gutter--15" data-ajax-content="inner">
                                        ...
                                        @foreach($firstCategory->news_limit as $news )
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="news-single-v1.html" class="thumb"><img
                                                                src="{{asset($news->thumbnail_path)}}"
                                                                alt="{{$news->title}}"/></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                            ...
                            <div class="col-md-6 ptop--30 pbottom--30">
                                ...
                                <div class="post--items post--items-3" data-ajax-content="outer">
                                    <ul class="nav" data-ajax-content="inner">
                                        ...
                                        @foreach($secondCategory->news_limit as $news )
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="news-single-v1.html" class="thumb"><img
