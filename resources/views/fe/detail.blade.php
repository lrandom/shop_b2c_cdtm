            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog-details-wrap">
                        <p class="category"><i class="fa fa-home"></i> Home / {{$post->category->name}}
                            / {{$post->title}}</p>
                        <h4>{{$post->title}}</h4>
                        ...
                        <div class="comment-area">
                            ...
                            @if($post->comments)
                                @foreach($post->comments as $comment)
                                    <div class="media">
                                        <div class="thumb">
                                            <img width="80" style="width:80px" src="http://placehold.jp/150x150.png"
                                                 alt="img">
                                        </div>
                            ...
                            <form method="post" action="{{route('fe.add-comment')}}" class="comment-form">
                                <h5>Leave a Reply</h5>
                                @csrf
